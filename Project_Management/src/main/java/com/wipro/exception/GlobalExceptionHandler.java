...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> handleStudentIdNotFoundException(ProjectIdNotFoundException exception)
	{
		
		return new ResponseEntity<ErrorMessage>(new ErrorMessage("project_ID_NOT_FOUND",exception.getMessage()),HttpStatus.NOT_FOUND);
